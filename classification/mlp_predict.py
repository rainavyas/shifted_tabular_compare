...
from train_mlp import normalize, get_lab_to_ind, MLP, get_default_device
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='mlp predict.')
    ...
    if not os.path.isdir('CMDs'):
        os.mkdir('CMDs')
    with open('CMDs/mlp_predict.cmd', 'a') as f:
